		...
		_Tpl : {
			...
			'view2' : '<div class="datagrid-view2" id="view2_<%=id%>" style="width:0px;height:100%;">'
							...
							+'<div class="datagrid-body" id="view2-datagrid-body-<%=id%>" style="width: 100%;height:0px;">'
								...
								+'</table>'
							+'</div>'
							+'<div class="datagrid-footer" id="view2-datagrid-footer-<%=id%>" style="width: 100%; height:0px; "></div>'
					+'</div>',
...
//				}
		...
		loadRows : function(m){
			...
			var _func = function(){
				...
				if( opt._trHeight<=0 ) {
					self.denyEventInvoke('_insert',0,data[0],false);	
		...
		lazyLoadRow : function(){
			...
			var vh = opt._trHeight*data.length;
...
//		},
		...
		view2_footer_row : function(d){
			...
			tr.push(' datagrid-row-index="');
			tr.push(d.i);
			tr.push('" datagrid-footer-row-select="0" class="datagrid-row datagrid-row-'+d.i+' datagrid-footer-row ');
			tr.push('">');
		...
		view1_footer_row : function(d){
			...
			tr.push(' datagrid-row-index="');
			tr.push(d.i);
			tr.push('" datagrid-footer-row-select="0" class="datagrid-row  datagrid-row-'+d.i+' datagrid-row-view1 ');
			tr.push('">');
		...
		setFooterRow : function(){
			...
			var _d = {};
			var view2_tbodyId = $("#view2-datagrid-footer-"+opt.id);
			var view1_tbodyId = $("#view1-datagrid-footer-"+opt.id);
		...
		onScroll : function(auto){
			...
			//footer
			$("#view2-datagrid-footer-"+opt.id)._scrollLeft( opt.sLeft );
